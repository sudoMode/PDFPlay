...
# COLOR = (190, 190, 190)
# COLOR = colors.red
COLOR = colors.Color(100, 0, 0, alpha=0.25)
...
def main():
    print('Called main..........')
    input_file = '/Users/mandeepsingh/dev/k2q/projects/WatermarkPDF/source/watermark_pdf/.data/test_doc.pdf'
    wm_text = 'test_wm'
    action = 'watermark'
    mode = 'RAM'
    watermark_unwatermark_file(input_file=input_file, wm_text=wm_text, action=action,
                               mode='RAM')
