...
from pdf_play.core import watermark as watermark_
...
def _watermark_mto(texts=('PDFPlay',), target_file=None, output_directory=None,
    ...
    for text in texts:
        watermark_(text, target_file, output_file=output_file, font_name=font_name,
...
def _watermark_otm(text='PDFPlay', target_files=None, output_directory=None,
    ...
    for file in target_files:
        watermark_(text, file, output_file, font_name=font_name, font_size=font_size,
...
def _watermark_oto(text='PDFPlay', target_file=None, output_file=None,
                   font_name='Helvetica-Bold',
                   font_size='medium', text_alignment='diagonal'):
    watermark_(text, target_file, output_file, font_name=font_name, font_size=font_size,
               text_alignment=text_alignment)
